...
function createListElement() {
    ...
    //Add content to it (the value of text in input)
    ...
    function markDone() {
        //If the li does not have the class of "done" applied to it, it will be applied. If if does, it will be taken off.
        li.classList.toggle("done");
    }

    li.addEventListener("click", markDone);

    //Create the delete button that will be deleted to our list item
    ...
    //Function will be called whenever the delete whenever the delete button is clicked
...
//This is going to be used to create a list element when the submit button is pressed
function createListItemSubmitButton() {
    //Check to make sure out input actually has some text. An empty string will have a length of 0
